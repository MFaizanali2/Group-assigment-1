...
function clickone() {
    ...
    image.innerHTML = `<img src="images/html.jpg" style="width:400px; height:300px" alt="html pic">`
}
...
function clicktwo() {
    ...
    image.innerHTML = `<img src="images/css.jpg" style="width:400px; height:300px" alt="css pic">`
}
...
function clickthree() {
    ...
    image.innerHTML = `<img src="images/javascript1.jpg" style="width:400px; height:300px" alt="javascript pic">`
}